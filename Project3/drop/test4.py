...
def main():
    ...
    args.batch_size  = 16
    """ 1000
    [860, 559, 550, 518, 609, 586]
    [860, 860, 860, 860, 860, 860]
    [100.0, 65.0, 63.95, 60.23, 70.81, 68.14]
    ------------------------------------------
    [97, 103, 104, 115, 106, 113]
    [201, 201, 201, 201, 201, 201]
    [48.26, 51.24, 51.74, 57.21, 52.74, 56.22]
    """
    ...
    # 定义模型并训练，测试
    model = Stock3(input_size=args.input_size, hidden_size=args.hidden_size, num_layers=args.layers , output_size = 2, batch_first=args.batch_first)
