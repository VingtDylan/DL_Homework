...
def split_data_label_2(sequence, data_label):
    ...
    for i in range(data_label.shape[0] - sequence - 20):
        ...
        Y.append(np.array(data_label.iloc[i + sequence + 20, -6 : ], dtype = np.float32))
    return X, Y
...
def main():
    ...
    # print(train_data_label_20d.shape)
    # print(train_data_label_20d)
    # print(test_data_label_20d.shape)
    # print(test_data_label_20d)

    sequence = args.sequence_length
    trainx, trainy = split_data_label_2(sequence = sequence,  data_label = train_data_label_20d)
    testx, testy = split_data_label_2(sequence = sequence,  data_label = test_data_label_20d)
